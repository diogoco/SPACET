...
<div class="container-fluid barra-cliente">
    <div class="text-right">
        ...
        <?php if(funcoes::VerificarLoginCliente()): ?>
            ...
            <!-- dropdown -->
            <div class="dropdown d-inline md-3">
                <button class="btn btn-primary btn-sm dropdown-toggle" type="button" id="d1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
