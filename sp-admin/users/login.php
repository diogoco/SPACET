<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        //procurar o user na base de dados
        ...
        if(count($dados) == 0){
            ...
            //LOG
            funcoes::CriarLOG('user '.$_SESSION['nome'].' fez login.', $_SESSION['nome']);
        }
    }
?>
        ...
        <div class="col-md-4 card m-3 p-3">
            ...
            <form action="?a=login" method="post">
                <div class="form-group">
                    <input type="text" name="text_user" class="form-control" placeholder="user">
                </div>
                <div class="form-group">
