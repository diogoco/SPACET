<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        // verifica se o novo email está a ser usado por outro user
        $parametros = [
        ...
        if(!$erro){
            ...
            //LOG
            funcoes::CriarLOG('user '.$_SESSION['nome'].' alterou o seu email.',$_SESSION['nome']);
        }
    }
// ==========================================================================
?>
